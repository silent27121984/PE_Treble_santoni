...
# Google Lens
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/pixelstyle/etc/sysconfig/pixel_2017_exclusive.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sysconfigs/pixel_2017_exclusive.xml \
    $(LOCAL_PATH)/pixelstyle/etc/sysconfig/pixel_2017.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sysconfigs/pixel_2017.xml \
    $(LOCAL_PATH)/pixelstyle/etc/sysconfig/nexus.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sysconfigs/nexus.xml \
    $(LOCAL_PATH)/pixelstyle/etc/sysconfig/google_build.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sysconfigs/google_build.xml
